...
| <a name="module_stack"></a> [stack](#module\_stack) | ../stack | n/a |
...
| <a name="input_component_type"></a> [component\_type](#input\_component\_type) | Component type (terraform or helmfile) | `string` | `"terraform"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_base_component"></a> [base\_component](#output\_base\_component) | Base component name |
| <a name="output_settings"></a> [settings](#output\_settings) | settings for the component |
