...
| Name | Type |
|------|------|
| [utils_spacelift_stack_config.spacelift_stacks](https://registry.terraform.io/providers/cloudposse/utils/latest/docs/data-sources/spacelift_stack_config) | data source |
...
| Name | Description |
|------|-------------|
| <a name="output_spacelift_stacks"></a> [spacelift\_stacks](#output\_spacelift\_stacks) | Spacelift stacks |
