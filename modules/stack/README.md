...
| <a name="input_stack"></a> [stack](#input\_stack) | Stack name. If specified, will be returned as is. If not specified, will be calculated using the provided `context` | `string` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_stack_name"></a> [stack\_name](#output\_stack\_name) | Stack name |
