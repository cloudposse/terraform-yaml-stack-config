...
| <a name="input_process_component_deps"></a> [process\_component\_deps](#input\_process\_component\_deps) | Boolean flag to enable/disable processing stack config dependencies for the components in the provided stack | `bool` | `true` | no |
